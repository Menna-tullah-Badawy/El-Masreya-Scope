...
PRODUCTS = [
    ...
    ("SC-RES-001", "philips-everflo-oxygen", "مولد أكسجين فيليبس EverFlo 5L",
     ...
     "/uploads/p-oxygen-concentrator.jpg",
